...
#define TEC             0x1C
#define REC             0x1D
#define CLKCTRL         MCP2515REG_CANCTRL
...
#define MCP2515_transmit(address)		do{MCP2515_WriteBits(address, TXB_TXREQ_M, TXB_TXREQ_M);}while(0)
...
static unsigned char MCP2515_ReadStatus(void);
